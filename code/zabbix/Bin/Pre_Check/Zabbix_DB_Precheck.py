    #File Name:- Zabbix_DB_Precheck.py
    #Service Name:- 
    #Purpose: To validate zabbix pre requisites with recommended values and output result
    #Author Name: Akhil Kumar
    #Create Date: 19/Apr/2019
    #Modifed By:- 
    #Last Modify Date: 24/09/2020
    #Current Version: 1.0
    #Summary of Last Change: Refactroing Code
    #Arguments: Global.txt file present in Input folder is a mandate
    #Argument : global.json file present in Input Folder as matadata



    import logging, time, subprocess, os, sys, threading, json,requests
    import datetime
    ...
    def __init__(self):
        ...
        self.output = open(self.root + "/zabbix/Output/Zabbix_Precheck_DB_" + str(dt) + ".txt", "w+")
        ...
        self.log_file = self.root + "/zabbix/Logs/Zabbix_Precheck_DB_" + dt + ".log"
