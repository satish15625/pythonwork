    # File Name:- Zabbix_Proxy_Precheck.py
    # Service Name:- N/A
    # Purpose: To perform prechecks on zabbix proxy
    # Author Name: Sankar
    ...
    def __init__(self):
        ...
        self.output = open(self.root + "/zabbix/Output/Zabbix_Proxy_Precheck_" + dt + ".txt", "w+")
        ...
        self.log_file = self.root + "/zabbix/Logs/Zabbix_Proxy_Precheck_" + dt + ".log"
