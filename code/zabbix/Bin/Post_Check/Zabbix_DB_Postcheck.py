# File Name:- Zabbix_DB_Postcheck.py
# Service Name:- N/A
...
class DB_Postcheck():
    ...
    def __init__(self):
        ...
        self.output = open(self.root + "/zabbix/Output/Zabbix_DB_Postcheck_" + dt + ".txt", "a+")
        ...
        self.log_file = self.root + "/zabbix/Logs/Zabbix_DB_Postcheck_" + dt + ".log"
