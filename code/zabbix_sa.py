...
class ToolDeployer():
    ...
    def call_ansible_role(self, role_name, server, ):
        ...
        # self.logger.info(self.ini_file)
        # self.logger.info(server)
        # self.logger.info(rolepath)
        # self.logger.info(self.extra_vars)
        self.logger.info(command)
        status,output = commands.getstatusoutput(command)
        result = self.code_finder(str(output))
        self.error_identifier_dict[result[2]].append([role_name,server,result[1]]) 
        
        #self.logger.info("Ansible Role Called Successfully "+self.dt)
    ...
    def alert_and_copy(self):
        ...
        # Copying scripts
        self.call_ansible_playbook("zabbix_script_copy.yml")	
    ...
    def precheck(self):
        ...
        self.logger.info('Test zabbix sa Preecheck function called')
        threads = []
    ...
    def installation(self):
        db_install_dict = {
            ...
            "zabbix_db_proxy_install_primary" : "Primary_DB_Proxy_Zabbix",
